...
<body class="text-white" style="background-color:  #1D3557">
    <h2 class="text-center mt-2">المبيعات</h2>
    ...
    <div class="container border border-3">
        <div class="row mt-2 d-flex justify-content-center">
            ...
            <h5 class="col-sm-1">الي</h5>
            <div class="col-sm-2">
                <input type="date">
            </div>
            <h5 class="col-sm-1">من</h5>
        </div>
        <div class="mt-4 d-flex justify-content-center">
            <div class="col-1 btn btn-primary" style="width: 200px;">بحث</div>
        </div>
        <div class="row d-flex justify-content-center mt-5 mb-3" style="margin-left: 200px;">
            <div class="col-4 border border-3">
                <p class="text-center">الاجمالي</p>
            </div>
